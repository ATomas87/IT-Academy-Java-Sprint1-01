...
public class Main {
    public static Redaccion redaccion = new Redaccion();
    ...
    public static void introducirRedactor() {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void mostrarMenuIntroducirNoticia() {
    ...
    public static Redactor encontrarRedactorByDni(String dni) {
    ...
    public static void mostrarRedactores() {
        redaccion.getRedactores().forEach(System.out::println);
    }

    public static void introducirNoticiaARedactor() {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void eliminarNoticia() {
        ...
        if (redactor != null) {
            ...
            if (!redactor.getNoticias().removeIf(noticia -> titular.equalsIgnoreCase(noticia.getTitular()))) {
    ...
    public static void mostrarNoticiasRedactores() {
